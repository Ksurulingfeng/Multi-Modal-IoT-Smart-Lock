...
const unsigned char Hzk[][32] =
    {
        //  正(0) 在(1) 验(2) 证(3) 成(4) 功(5) 失(6) 败(7) 指(8) 纹(9) 密(10) 码(11) 超(12) 时(13) 次(14) 数(15)
        //  过(16) 多(17) 请(18) 后(19) 再(20) 试(21) 输(22) 入(23) 退(24) 格(25) 确(26) 认(27) 智(28) 能(29) 门(30) 锁(31)
        //  删(32) 除(33) 按(34) 下(35) 手(36) 录(37) 入(38) 中(39) 将(40) 卡(41) 片(42) 靠(43) 近(44) 修(45) 改(46) 采(47)
        //  集(48) 添(49) 加(50) 退(51) 出(52)
        ...
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xE2, 0x1C, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
        {0x80, 0x40, 0x20, 0x10, 0x0C, 0x03, 0x00, 0x00, 0x00, 0x03, 0x0C, 0x30, 0x40, 0x80, 0x80, 0x00}, /*"入",38*/
        {0x00, 0x00, 0xF0, 0x10, 0x10, 0x10, 0x10, 0xFF, 0x10, 0x10, 0x10, 0x10, 0xF0, 0x00, 0x00, 0x00},
        {0x00, 0x00, 0x0F, 0x04, 0x04, 0x04, 0x04, 0xFF, 0x04, 0x04, 0x04, 0x04, 0x0F, 0x00, 0x00, 0x00}, /*"中",39*/
        {0x00, 0x08, 0x30, 0x00, 0xFF, 0x00, 0x88, 0x84, 0x53, 0x22, 0x12, 0xCA, 0x06, 0x00, 0x00, 0x00},
        {0x04, 0x04, 0x02, 0x01, 0xFF, 0x00, 0x02, 0x0A, 0x12, 0x42, 0x82, 0x7F, 0x02, 0x02, 0x02, 0x00}, /*"将",40*/
        {0x40, 0x40, 0x40, 0x40, 0x40, 0x40, 0xFF, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x40, 0x40, 0x00},
        {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x02, 0x04, 0x08, 0x10, 0x00, 0x00, 0x00}, /*"卡",41*/
        {0x00, 0x00, 0x00, 0xFE, 0x20, 0x20, 0x20, 0x20, 0x20, 0x3F, 0x20, 0x20, 0x20, 0x20, 0x00, 0x00},
        {0x00, 0x80, 0x60, 0x1F, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00}, /*"片",42*/
        {0x08, 0x08, 0x0C, 0xEB, 0xAA, 0xAA, 0xAA, 0xAF, 0xAA, 0xAA, 0xAA, 0xEA, 0x08, 0x08, 0x08, 0x00},
        {0x00, 0x22, 0x2A, 0x2A, 0x2A, 0xFF, 0x00, 0x00, 0x00, 0xFF, 0x2A, 0x2A, 0x2A, 0x22, 0x00, 0x00}, /*"靠",43*/
        {0x40, 0x40, 0x42, 0xCC, 0x00, 0x00, 0x00, 0xFC, 0x24, 0x24, 0x24, 0xE2, 0x23, 0x22, 0x20, 0x00},
        {0x00, 0x40, 0x20, 0x1F, 0x20, 0x50, 0x4C, 0x43, 0x40, 0x40, 0x40, 0x5F, 0x40, 0x40, 0x40, 0x00}, /*"近",44*/
        {0x40, 0x20, 0xF8, 0x07, 0xF0, 0xA0, 0x90, 0x4C, 0x57, 0x24, 0xA4, 0x54, 0x4C, 0x80, 0x80, 0x00},
